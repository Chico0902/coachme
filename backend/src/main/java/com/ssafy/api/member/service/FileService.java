...
//    File file = memberRepository.findByUploaderAndType(customUserDetailsService.loadUserByUsername(memberId), "profile");
//    return file.getUrl();
//  }
//
//
...
//    File file = fileRepository.findByUploaderAndType(customUserDetailsService.loadUserByUsername(memberId), "profile");
//    if (file != null) {
//      try {
//        // S3에서 객체 삭제
