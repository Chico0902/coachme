...
const mockAdminElevationsResponseDtos = {
  data: [
    {
      name: '김코미',
      id: '3',
...
const mockAdminElevateResponseDtos = { data: { message: '회원정보 수정 완료' } }

export default [
  http.get(`http://localhost/admin/members`, () => {
    return HttpResponse.json(mockAdminMembersResponseDtos)
  }),
  http.get(`http://localhost/admin/privileges/elevations`, () => {
    return HttpResponse.json(mockAdminElevationsResponseDtos)
  }),
  http.patch(`http://localhost/admin/privileges/elevations/1`, () => {
    return HttpResponse.json(mockAdminElevateResponseDtos)
  })
]
