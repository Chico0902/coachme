...
<template>
    ...
    <section style="width: 75%; ">
      <div class="frame">
        ...
        style="background-color: white; margin-top: 1vh;">
          ...
          <!-- 코치 카드 영역 -->
          <selectCoachCard :coachName="card.memberName" :coaching="card.lessonInfo" :rating="card.avgScore"
            :reviewCount="card.reviewCount" :img="card.profileImg"></selectCoachCard>
        </q-card>
      </div>
  ...
  <template v-else>
    <q-card style="min-width: 50vw; height: 15vh; margin-top: 2vh; margin-left: 0.6vw;" 
    :rounded="true" :color="cardColor">
