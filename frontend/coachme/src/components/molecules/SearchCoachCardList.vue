...
const cards = ref([
  { name: 'Korean Fried', category: '한국', rating: '4.6', reviewCount: 122 , img: `${cloudUrl}tender01.jpg` },
  { name: 'Grilled', category: '그릴', rating: '4.6', reviewCount: 122, img: `${cloudUrl}tender02.jpg` },
  { name: 'Fried', category: '튀김', rating: '4.6', reviewCount: 122,  img: `${cloudUrl}tender03.jpg` },
  { name: 'Deep Fried', category: '아무튼 치킨', rating: '4.6', reviewCount: 122, img: `${cloudUrl}tender04.jpg` }
]);
