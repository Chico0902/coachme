...
const props = defineProps({
  ...
  breadCrumbs : { // 코칭 대분류, 소분류
    type : Object
  }, 
  previewVideoSrc : { // 코칭 미리보기 영상 주소
    type : String
  },
  coach : {  // 코치 이름
    type : String,
      ...
      <q-item-section vertical>
        ...
        <q-item-section>
          <div class="row no-wrap items-center" style="margin-top: 1vh;">
            ...
            <Labels style="font-size: 20px; margin-top: 6vh; margin-left: 2.5vw; width: fit-content;" :label="props.coach"></Labels>
          </div>
        </q-item-section>
